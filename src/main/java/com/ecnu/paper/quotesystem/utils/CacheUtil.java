...
import com.ecnu.paper.quotesystem.bean.enums.RedisPreEnum;
import com.ecnu.paper.quotesystem.bean.po.Construct;
...
import com.ecnu.paper.quotesystem.service.ConstructService;
import com.ecnu.paper.quotesystem.service.DictionaryService;
import com.ecnu.paper.quotesystem.service.RedisService;
import com.ecnu.paper.quotesystem.service.StoreService;
...
public class CacheUtil implements InitializingBean {
    ...
    protected final Logger logger = LoggerFactory.getLogger(CacheUtil.class);
