...
import com.ecnu.paper.quotesystem.bean.request.BagConstructRequestBean;
import com.ecnu.paper.quotesystem.bean.request.BatchUploadConstructPriceRequest;
import com.ecnu.paper.quotesystem.bean.request.BatchUploadConstructRequest;
import com.ecnu.paper.quotesystem.bean.request.CalculationFormulaBean;
import com.ecnu.paper.quotesystem.bean.request.ConstructBean;
import com.ecnu.paper.quotesystem.bean.request.ConstructPriceBean;
import com.ecnu.paper.quotesystem.bean.request.PackageConstructRequestBean;
import com.ecnu.paper.quotesystem.bean.request.QueryConstructBean;
import com.ecnu.paper.quotesystem.bean.request.QueryConstructPriceBean;
import com.ecnu.paper.quotesystem.bean.request.QueryExportConstructbean;
import com.ecnu.paper.quotesystem.bean.response.CommonRespBean;
import com.ecnu.paper.quotesystem.bean.response.PackageConstructResponseBean;
...
import com.ecnu.paper.quotesystem.service.PackageConstructService;
...
public class ConstructResource {
    ...
    private final Logger logger = LoggerFactory.getLogger(ConstructResource.class);
