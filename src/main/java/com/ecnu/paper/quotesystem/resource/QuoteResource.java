...
import com.ecnu.paper.quotesystem.bean.exception.ErrorMsgBean;
...
import com.ecnu.paper.quotesystem.bean.response.GetQuoteSummaryRespBean;
...
import com.ecnu.paper.quotesystem.bean.response.QuoteRoomTextileRespBean;
...
public class QuoteResource {
    protected final Logger logger = LoggerFactory.getLogger(QuoteResource.class);
